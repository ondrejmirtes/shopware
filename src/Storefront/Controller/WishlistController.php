...
class WishlistController extends StorefrontController
{
    ...
    #[Route(path: '/wishlist/ids', name: 'frontend.wishlist.ids', options: ['seo' => false], defaults: ['XmlHttpRequest' => true, '_loginRequired' => true], methods: ['GET'])]
    public function ids(CustomerEntity $customer): Response
    {
